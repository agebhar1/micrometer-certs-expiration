...
----
ifndef::env-github[]
include::samples/micronaut5/src/main/java/io/github/agebhar1/micrometer/security/cert/DemoMicrometerCertsExpirationApplication.java[tag=factory]
endif::[]
ifdef::env-github[]
    @Factory
    @RequiresMetrics
...
See link:samples/micronaut5/src/main/java/io/github/agebhar1/micrometer/security/cert/DemoMicrometerCertsExpirationApplication.java[example] (Micronaut 5).
