...
----
ifndef::env-github[]
include::samples/micronaut/src/main/java/io/github/agebhar1/micrometer/security/cert/DemoMicrometerCertsExpirationApplication.java[tag=bean]
endif::[]
ifdef::env-github[]
    @Bean
    @Singleton
...
See link:samples/micronaut/src/main/java/io/github/agebhar1/micrometer/security/cert/DemoMicrometerCertsExpirationApplication.java[example].
